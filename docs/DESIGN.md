...
> Design notes for **ecommerce-page-change-monitor** — a runnable python example that A typed Python service that detects product page changes and emits order update events.
...
- **Feature code** — the actual task: ecommerce monitoring.
